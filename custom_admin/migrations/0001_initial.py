# Generated by Django 2.2.11 on 2021-05-04 06:26

import custom_admin.managers
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', custom_admin.managers.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Categories',
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='custom_admin.Categories')),
            ],
        ),
    ]
